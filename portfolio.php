...
<div class="col-xxl-8 mx-auto p-3 ty-md-5">
	<main>
		...
		<div class="row mt-4 px-4">
			<h2>Portfólio</h2>
			<p>Atuo como <strong class="text-purple-500">consultora freelancer para soluções digitais</strong> com foco nas áreas de gestão de produtos digitais, arquitetura da informação e de desenvolvimento de sites.</p>
				...
				<div class="col">
					<div class="card shadow-sm w-100">
						...
						<div class="card-body">
							...
							<h5 class="card-title mt-3">Estudo de caso de gestão de produto digital</h5>
							<p class="card-text">Documentação de discovery e delivery, e criação de protótipo de um produto digital. Projeto realizado para curso de Product Management (Awari).</p>
						</div>
				...
				<div class="col">
					<div class="card shadow-sm w-100">
						...
						<div class="card-body">
							...
							<h5 class="card-title mt-3">Reformulação da arquitetura da informação de site</h5>
				...
				<div class="col">
					<div class="card shadow-sm">
						...
						<div class="card-body">
							...
							<p class="card-text">Site estático comemorativo ao Dia do Bibliotecário, criado para ARB em 2017.</p>
						</div>
						<div class="card-footer bg-white border-white text-end">
